...
import chap08.member.Code;
import chap08.member.MemberRegistRequest;
import chap08.member.MemberRegistValidator;
...
public class RegistrationController
{
    ...
    public String regist(@ModelAttribute("memberInfo") MemberRegistRequest memRegReq, BindingResult bindingResult)
    {
        ...
        if (bindingResult.hasErrors()) { return MEMBER_REGISTRATION_FORM; }
        System.out.println(memRegReq);
