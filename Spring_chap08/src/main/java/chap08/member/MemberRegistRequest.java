...
public class MemberRegistRequest
{
    ...
    {
        return "MemberRegistRequest [email=" + email + ", name=" + name + ", password=" + password + ", confirmPassword=" + confirmPassword + ", allowNoti=" + allowNoti + ", address=" + address + ", birthday=" + birthday + "]";
    }
