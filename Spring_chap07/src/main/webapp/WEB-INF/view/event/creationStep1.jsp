...
<body>
	...
	<form:form commandName="eventForm"
		action="${pageContext.request.contextPath}/newevent/step2">
...
<input type="text" name="beginDate"
			value='<fmt:formatDate value="${eventForm.beginDate}" pattern="yyyyMMdd"/>' />부터 
<input type="text" name="endDate"
			value='<fmt:formatDate value="${eventForm.endDate}" pattern="yyyyMMdd"/>' />까지
<form:errors path="beginDate" />
	...
	세션 존재 여부:
	<%=session.getAttribute("eventForm") != null ? "존재" : "없음"%>
</body>
</html>