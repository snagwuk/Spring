...
import src.AuthException;
import src.AuthenticationService;
import src.PasswordChangeService;
import src.UserNotFoundException;

import org.springframework.context.support.GenericXmlApplicationContext;

public class MainByFilePath {

        public static void main(String[] args) {
                GenericXmlApplicationContext ctx = 
                                new GenericXmlApplicationContext("file:src/main/resources/config.xml");
