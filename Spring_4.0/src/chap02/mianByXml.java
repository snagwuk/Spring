...
public class mianByXml
{
    
    public static void main(String[] args)
    {
        // TODO Auto-generated method stub
        GenericXmlApplicationContext ctx = new GenericXmlApplicationContext("classpath:chap02.xml");
    ...
    private static void runAuthAndCatchAuthEx(AuthenticationService authSvc,
