	...
	<ul>
		<li>HttpMessageConverter:
			<ul>
				...
				<li><a href="guestmessage/list.xml">/guestmessage/list.xml</a>:
					자바객체-&gt;XML응답, GuestMessageController.listXml()</li>
				<li><a href="javascript:postXml()">/guestmessage/post.xml</a>:
					XML요청-&gt;자바객체, GuestMessageController.postXml()</li>
				<li><a href="guestmessage/list.json">/guestmessage/list.json</a>:
					자바객체-&gt;JSON응답, GuestMessageController.listJson()</li>
			</ul>
		</li>
		<li>파일 업로드:
			<ul>
